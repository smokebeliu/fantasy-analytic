...
| 14 | Импорт активного сезона 2026/2027 и разделение сезонов | 2, 4, 5 | `READY` |
| 15 | Кросс-сезонный прогноз состава на первый тур | 6, 7, 8, 14 | `PLANNED` |
| 16 | Полная статистика в таблице игроков (сортировка по очкам, без фильтра по турам) | 9, 10 | `READY` |
| 17 | Раздел «Состав»: поле-схема, переключение вида, group-button фильтр | 8, 10 | `READY` |
| 18 | Фиксация игроков и подбор оптимального состава под схему | 8, 9, 17 | `PLANNED` |
| 19 | Учёт соперников следующего тура в оптимизации | 8, 15 | `PLANNED` |
| 20 | Сила команд и AI-коэффициенты | 6, 7, 15 | `PLANNED` |

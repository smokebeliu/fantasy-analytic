...
Текущий прогресс: 19 из 21 шагов завершён.
...
Незавершённые шаги (18 и 20) занумерованы по порядку приоритета: чем меньше
...
Оставшиеся: `18 → 20` (нумерация совпадает с приоритетом).

## Шаги

Завершённые шаги (0–17 и 19) даны сводкой «цель + зависимости»; их детали и

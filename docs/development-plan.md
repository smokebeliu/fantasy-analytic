...
Текущий прогресс: 17 из 21 шагов завершён.
...
Незавершённые шаги (17–20) занумерованы по порядку приоритета: чем меньше номер,
...
Оставшиеся: `17 → 18 → 19 → 20` (нумерация совпадает с приоритетом).

## Шаги

Завершённые шаги (0–16) даны сводкой «цель + зависимости»; их детали и карточки
выполнения — в [`docs/development-history.md`](development-history.md).
Незавершённые (17–20) описаны полностью (детали, критерии приёмки, границы).

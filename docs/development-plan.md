...
Текущий прогресс: 15 из 21 шагов завершён.
...
| 15 | Фиксация игроков и подбор оптимального состава под схему | 8, 9, 13 | `P2` | `IN_PROGRESS` |
...
Оставшиеся: `15 → 16 → 17 → 18 → 19 → 20` (нумерация совпадает с приоритетом).

## Шаги

Завершённые шаги (0–14) даны сводкой «цель + зависимости»; их детали и карточки
выполнения — в [`docs/development-history.md`](development-history.md).
Незавершённые (15–20) описаны полностью (детали, критерии приёмки, границы).

...
| 11 | Импорт активного сезона 2026/2027 и разделение сезонов | 2, 4, 5 | `P0` | `READY` |
| 12 | Полная статистика в таблице игроков (сортировка по очкам, без фильтра по турам) | 9, 10 | `P1` | `READY` |
| 13 | Раздел «Состав»: поле-схема, переключение вида, group-button фильтр | 8, 10 | `P1` | `READY` |
| 14 | Кросс-сезонный прогноз состава на первый тур | 6, 7, 8, 11 | `P1` | `PLANNED` |
...
Не входит: кросс-сезонный прогноз (шаг 14).
